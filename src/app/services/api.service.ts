...
export class ApiService {
  ...
  setTheme(newTheme: ThemeType) {
    ...
    html.classList.remove('dark', 'theme-angel', 'theme-pearl');
    
    if (newTheme === 'dark') {
      html.classList.add('dark');
    } else if (newTheme === 'angel') {
      html.classList.add('theme-angel', 'dark');
    } else {
      // Pearl (Default) - Explicitly add class now
      html.classList.add('theme-pearl');
    }
  }
